...
from amaranth            import Shape, Signal, Elaboratable, Module, Array
...
class USBInTransferManager(Elaboratable):
    ...
    def elaborate(self, platform):
        ...
        m.submodules.transmit_buffer_0 = transmit_buffer_0 = Memory(shape=Shape(8), depth=self._max_packet_size, init=[])
        m.submodules.transmit_buffer_1 = transmit_buffer_1 = Memory(shape=Shape(8), depth=self._max_packet_size, init=[])
