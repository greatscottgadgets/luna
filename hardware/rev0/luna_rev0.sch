...
VBUS_PASSTHROUGH_EN
$Sheet
S 4100 1650 1700 950 
U 5DE77FE3
F0 "RAM / 1V8 Section" 50
F1 "ram_section.sch" 50
$EndSheet
Text Notes 4350 2150 0    100  ~ 0
64Mib HyperRAM
Wire Wire Line
	5800 3250 6300 3250
Wire Wire Line
...
F 2 "luna:SWITCH-FSMRA" H 2350 5550 50  0001 C CNN
F 3 "~" H 2350 5550 50  0001 C CNN
F 4 "SWITCH TACTILE SPST-NO 0.05A 24V" H 2350 5550 50  0001 C CNN "Description"
F 5 "TE Connectivity" H 2350 5550 50  0001 C CNN "Manufacturer"
F 6 "1825027-5" H 2350 5550 50  0001 C CNN "Part Number"
	1    2350 5550
	1    0    0    -1  
$EndComp
Wire Wire Line
...
F 2 "luna:SWITCH-FSMRA" H 2350 5900 50  0001 C CNN
F 3 "~" H 2350 5900 50  0001 C CNN
F 4 "SWITCH TACTILE SPST-NO 0.05A 24V" H 2350 5900 50  0001 C CNN "Description"
F 5 "TE Connectivity" H 2350 5900 50  0001 C CNN "Manufacturer"
F 6 "1825027-5" H 2350 5900 50  0001 C CNN "Part Number"
	1    2350 5900
	1    0    0    -1  
$EndComp
...
F 2 "Resistor_SMD:R_0402_1005Metric" V 6830 4050 50  0001 C CNN
F 3 "~" H 6900 4050 50  0001 C CNN
F 4 "GENERIC-RES-0402-10K" H 6900 4050 50  0001 C CNN "Part Number"
	1    6900 4050
	0    1    1    0   
$EndComp
Wire Wire Line
...
U 1 1 5DEC924F
P 7100 4050
F 0 "#PWR0117" H 7100 3900 50  0001 C CNN
F 1 "+3V3" V 7114 4178 50  0000 L CNN
...
U 1 1 5DD6DEF2
P 10600 2500
F 0 "J3" H 10371 2489 50  0000 R CNN
F 1 "USB_A" H 10371 2399 50  0000 R CNN
F 2 "luna:USB_A_Kycon_KUSBXHT-SB-AS1N-B30-NF_Horizontal" H 10750 2450 50  0001 C CNN
F 3 " ~" H 10750 2450 50  0001 C CNN
F 4 "USB A TYPE RECEPTACLE, SHORT BODY" H 10600 2500 50  0001 C CNN "Description"
F 5 "Jing Extension of the Electronic Co." H 10600 2500 50  0001 C CNN "Manufacturer"
F 6 "C42504" H 10600 2500 50  0001 C CNN "Part Number"
	1    10600 2500
	-1   0    0    -1  
$EndComp
Wire Wire Line
...
F 1 "GND" H 10654 2878 50  0000 C CNN
...
Wire Wire Line
	6850 4800 7150 4800
$Sheet
S 4100 3050 1700 1550
U 5DDDB747
F0 "Target Section" 50
F1 "target_side.sch" 50
F2 "TARGET_D+" B R 5800 3550 50 
F3 "TARGET_D-" B R 5800 3450 50 
F4 "TARGET_VBUS" I R 5800 3250 50 
F5 "TARGET_PHY_1V8" O L 4100 3500 50 
F6 "TARGET_FAULT" I R 5800 4150 50 
F7 "A_PORT_POWER_ENABLE" O R 5800 4350 50 
F8 "ALLOW_POWER_VIA_TARGET_PORT" O R 5800 4450 50 
F9 "TARGET_SBU1" B R 5800 3800 50 
F10 "TARGET_SBU2" B R 5800 3900 50 
$EndSheet
